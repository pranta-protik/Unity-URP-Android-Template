...
namespace Project.Unlockables
{
    public class PaymentPlatform : ValidatedMonoBehaviour
    {
        ...
        [TabGroup("Progression Settings")] [SerializeField] private float _fillDuration = 0.5f;
        ...
        {
            _progressBarFill.DOFillAmount(_unlockable.Value.GetDepositedAmountNormalized(), _fillDuration);
